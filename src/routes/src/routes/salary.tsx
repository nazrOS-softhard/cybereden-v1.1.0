      ...
      <div className="space-y-6 max-w-3xl">
        <div className="hud-corners p-6 border border-border bg-surface/30 backdrop-blur-sm">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            Поэтому зарплата выплачивается <strong>натуральными устройствами</strong>, произведёнными внутри экосистемы.
          </p>
        </div>
        ...
        <div className="hud-corners p-6 border border-border bg-surface/30 backdrop-blur-sm">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
            <li>Все сотрудники получают зарплату готовыми устройствами nazrOS (cloN, blaN, biohN, rostN, piN, visioN).</li>
            <li>Любой софт nazrOS открыт без подписок и платных дополнений.</li>
            <li>Устройства, полученные в качестве зарплаты, являются личной собственностью сотрудника.</li>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-left py-2 font-mono text-xs text-muted-foreground">Оклад (ед.)</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div className="hud-corners p-6 border border-border bg-surface/30 backdrop-blur-sm">
          ...
          <div className="p-4 border border-neon-cyan/20 rounded text-sm text-muted-foreground">
            <p className="italic">
              «Заработная плата выплачивается натуральными устройствами nazrOS (cloN, blaN, biohN, rostN, piN, visioN etc.). 
              Все программные продукты страННо, кефирННо и ядро nazrOS доступны без подписок и платных дополнений. 
              Сотрудник получает устройства на руки и становится их собственником.»
            </p>
          </div>
        </div>
      </div>
