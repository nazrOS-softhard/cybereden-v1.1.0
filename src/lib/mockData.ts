...
export const events: Event[] = [
  ...
  // ХАКАТОНЫ
  { id: "e13", title: "КиберХак 2027: БЕЗОПАСНОСТЬ БУДУЩЕГО", type: "ХАКАТОНЫ", date: "20.08.2027", location: "Offline · г. Москва", description: "Главный хакатон киберсистемы nazrOS. 48 часов непрерывного кодинга, менторство от топ-специалистов и призовой фонд." },
  { id: "e14", title: "назрОС РазрабКонф 2027", type: "ХАКАТОНЫ", date: "27.08.2090", location: "Portal Campus", description: "Конференция разработчиков киберсистемы nazrOS. Доклады, мастер-классы, нетворкинг." },
