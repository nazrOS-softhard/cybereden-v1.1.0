...

{
  ...
  description:
    "⚙️ DEV MODE\nФункционал в стадии активной сборки. Возможны изменения, отключения и горячие исправления. Следи за апдейтами.\n\nКИБЕРВАУЧЕР — чёрный кулон с логотипом nazros. Твой цифровой паспорт в новой реальности. Надеваешь — и ты уже не просто человек. Ты — узел сети.\n\nМы проанализировали визуальную структуру и партнёрскую карту. Вот что даёт тебе киберваучер в порядке приоритета:\n\n🔹 **Квалификация инвестора**\nАктивация через Telegram Wallet. После оплаты система присваивает тебе уникальный идентификационный номер. Он появляется в Кибле Кибера — и с этого момента ты часть закрытого сообщества.\n\n🔹 **Ранний доступ к устройствам киберсистемы nazros**\nТы первым получаешь в руки новые девайсы nazros — ещё до того, как их анонсируют. Первым видишь, первым касаешься, первым внедряешь в свою сеть.\n\n🔹 **Ранний доступ к софту киберсистемы nazros**\nТебе открываются прошивки, модули и программные продукты nazros на стадии бета-тестирования. Ты — тот, кто первым загружает новый код.\n\n🔹 **Система лояльности**\nЭксклюзивные скидки, подписки и сервисы в официальных магазинах брендов-партнёров: Samsung, Apple, Sony, Xiaomi, Huawei, Microsoft, Honor, Oppo, Vivo, Motorola, Nokia, OnePlus, Meizu, Lenovo, ASUS, LG, HTC, ZTE, Infinix, realme. И другие — те, чьи логотипы ещё не нанесли на карту.\n\n**Логика приобретения:**\n1. Нажимаешь «Приобрести» — система переносит тебя в Telegram-бот.\n2. Оплата через Telegram Wallet.\n3. Генерация уникального ID.\n4. ID отображается в Кибле Кибера.",
  sensors: [
    { label: "Статус КИ", unit: "", value: 1, min: 0, max: 1 },
    { label: "Ранний доступ", unit: "уровень", value: 5, min: 0, max: 10 },
    { label: "Идентификатор", unit: "ID", value: 0, min: 0, max: 999999 },
  ],
  sliders: [
    { label: "Версия протокола", value: 0.1, min: 0, max: 1, unit: "beta" },
    { label: "Партнёрская сеть", value: 80, min: 0, max: 100, unit: "%" },
  ],
}
];
...
export const events: Event[] = [
 ...
 streamUrl: "https://www.twitch.tv/lana_lux" // <--- ДОБАВЛЕНО 
  ...
  streamUrl: "https://www.twitch.tv/betboom_dota_ru" // <--- ДОБАВЛЕНО
},
