...
description:
  "⚡ DEV MODE<br>Функционал в стадии сборки. Возможны корректировки и горячие исправления.<br><br>" +
  "▸ КИБЕРВАУЧЕР — тёмная подвеска с логотипом nazrOS.<br>Твой цифровой паспорт в Цифровом конгломерате nazrOS.<br><br>" +
  "▸ ПРИОРИТЕТЫ<br>" +
  "  01. Квалификация инвестора<br>" +
  "      Активация через Telegram Wallet → ID в Кибле Кибера.<br>" +
  "  02. Ранний доступ к устройствам nazrOS<br>" +
  "      Новые девайсы до анонса.<br>" +
  "  03. Ранний доступ к софту nazrOS<br>" +
  "      Прошивки и модули на стадии бета-тестирования.<br>" +
  "  04. Система лояльности<br>" +
  "      Скидки и подписки у партнёров:<br>" +
  "      Международные: Samsung, Apple, Sony, Xiaomi, Huawei, Microsoft, Honor, Oppo, Vivo, Motorola, Nokia, OnePlus, Meizu, Lenovo, ASUS, LG, HTC, ZTE, Infinix, realme, Google, Nothing<br>" +
  "      Российские: Irbis, BQ, DEXP, F+, Inoi, Tecno, Vertex<br><br>" +
  "▸ ЛОГИКА ПРИОБРЕТЕНИЯ<br>" +
  "  1. «Приобрести» → Telegram-бот<br>" +
