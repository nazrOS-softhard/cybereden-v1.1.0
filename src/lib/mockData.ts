...
"▸ КИБЕРВАУЧЕР — тёмная подвеска с логотипом nazrOS. Твой цифровой паспорт в новой реальности.\n\n" +
"▸ ПРИОРИТЕТЫ\n" +
"  01. Квалификация инвестора\n" +
"  Активация через Telegram Wallet. После оплаты — уникальный ID в Кибле Кибера. Ты — часть закрытого сообщества.\n\n" +
"  02. Ранний доступ к устройствам nazrOS\n" +
"  Первым получаешь новые девайсы ещё до анонса. Видишь, касаешься, внедряешь.\n\n" +
"  03. Ранний доступ к софту nazrOS\n" +
"  Прошивки, модули и продукты на стадии бета-тестирования. Ты загружаешь код первым.\n\n" +
"  04. Система лояльности\n" +
"  Скидки, подписки и сервисы у партнёров:\n" +
...
"▸ ЛОГИКА ПРИОБРЕТЕНИЯ\n" +
"  1. Нажимаешь «Приобрести» → Telegram-бот\n" +
