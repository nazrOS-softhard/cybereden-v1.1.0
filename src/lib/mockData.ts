...
export const events: Event[] = [
  ...
  { id: "e16", title: "TWS: Плесетск", type: "ХАКАТОНЫ", date: "10.09.209", location: "Плесетск · Архангельская область", description: "The Week Space — цифровое космическое событие в рамках Российской недели космоса. Инженеры, дизайнеры, разработчики, медиа-артисты и исследователи собираются в единой среде будущего для обсуждения технологий, космической инфраструктуры и цифровых систем нового поколения." 
},
